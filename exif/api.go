...
// NewPreviewImageTag -
func NewPreviewImageTag(start FieldName, length FieldName) PreviewImageTag {
	return PreviewImageTag{start, length, 0, 0}
}
...
func (x Exif) PreviewImage(tags ...PreviewImageTag) (int64, int64, error) {
	tags = append(tags,
		NewPreviewImageTag(PreviewImageStart, PreviewImageLength),                        // IFD0 PreviewImage
		NewPreviewImageTag(ThumbJPEGInterchangeFormat, ThumbJPEGInterchangeFormatLength), // IFD0 ThumbnailImage
	)
